<template>
    <div id="index">
        <div class="header-x">
            ...
            <span class="title"><i class="icon iconfont icon-jinritoutiao-n"></i></span>
...
//                      console.log('flagup');
                        flagup = false;
                        ajax(self.tabkey).then((res) => {
                            self.saveStore(res.data)
                            self.$nextTick(()=>{
